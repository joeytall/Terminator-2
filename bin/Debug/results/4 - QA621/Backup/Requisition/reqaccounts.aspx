<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reqaccounts.aspx.cs" Inherits="requisition_reqaccounts" %>
...
<asp:Panel ID="MainControlsPanel" runat="server"  CssClass="MainControlsPanelClass">
  ...
  <telerik:RadAjaxManager ID="ajaxmanager" runat="server">
    <AjaxSettings>
      <telerik:AjaxSetting AjaxControlID="grdreqaccounts">
      <UpdatedControls>
        <telerik:AjaxUpdatedControl ControlID="grdreqaccounts" />
...
<asp:SqlDataSource ID="Accounts_SqlDataSource" runat="server" ProviderName="System.Data.OleDb"></asp:SqlDataSource>
  ...
  <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True" ShowSummary="False" ValidationGroup="reqaccounts" />
</asp:Panel>
...
<script type="text/javascript">
  ...
  function PercentChanged(costamountfield, totalfield, accounttotalfield, percentagefield, oldpercentagefield, accountcostfield, keeppercentfield) {
      ...
      function GetPercentageValue() {
          var table = document.getElementById('grdreqaccounts_ctl00');
