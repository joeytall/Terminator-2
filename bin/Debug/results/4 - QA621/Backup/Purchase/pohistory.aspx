<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pohistory.aspx.cs" Inherits="purchase_pohistory" %>
...
<body style="background-image: url(../IMAGES/back.png); background-repeat: repeat-x;
    ...
    <asp:Panel ID="MainControlsPanel" runat="server" CssClass="MainControlsPanelClass">
        ...
        <asp:SqlDataSource ID="POHistorySqlDataSource" runat="server" ProviderName="System.Data.OleDb">
        </asp:SqlDataSource>
    </asp:Panel>
