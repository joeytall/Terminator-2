...
public partial class location_locationpanel : System.Web.UI.Page
{
    ...
    AzzierScreen screen, screen2, screen3;
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        hidGetFirstRecord.Value = UserSettings.GetFirstRecordSetting("Location");
        ...
        screen = new AzzierScreen("location/locationpanel.aspx", "MainForm", MainControlsPanel.Controls, "edit");
        ...
        grdresults.MasterTableView.DataKeyNames = new string[] { "Location" };
        ...
        grdresults.MasterTableView.ClientDataKeyNames = new string[] { "Location" };
        ...
        grdresults.Attributes.Add("serviceURL", "../InternalServices/ServiceLoc.svc/QueryResultLocation");
        ...
        grdworklist.MasterTableView.DataKeyNames = new string[] { "Location" };
        ...
        grdworklist.MasterTableView.ClientDataKeyNames = new string[] { "Location" };
        ...
        screen2 = new AzzierScreen("location/locationpanel.aspx", "MainForm", MainControlsPanel2.Controls);
        ...
        grdworklist.ClientSettings.DataBinding.Location = "../InternalServices/ServiceLoc.svc";
        ...
        grdrecentlist.MasterTableView.DataKeyNames = new string[] { "Location" };
        ...
        screen3 = new AzzierScreen("location/locationpanel.aspx", "MainForm", MainControlsPanel3.Controls);
        ...
        grdrecentlist.MasterTableView.ClientDataKeyNames = new string[] { "Location" };
        ...
        grdrecentlist.ClientSettings.DataBinding.Location = "../InternalServices/ServiceLoc.svc";
    ...
    protected void grdworklist_PreRender(object sender, EventArgs e)
    {
        ...
        //GetLocations(WorkListSqlDataSource.SelectCommand, "worklist");
    ...
    protected void grdresults_PreRender(object sender, EventArgs e)
    {
        if (hidMode.Value == "queryresult")
        {
            ...
            //GetLocations(ResultsSqlDataSource.SelectCommand, "queryresult");
        }
    }

    protected void grdrecentlist_PreRender(object sender, EventArgs e)
    {
        //GetLocations(RecentListSqlDataSource.SelectCommand, "recentlist");
    ...
    {
      screen.GridItemCreated(e, "location/locationpanel.aspx", "MainForm", "results", grdresults);
    }

    protected void grdworklist_ItemCreated(object sender, GridItemEventArgs e)
    {
      screen2.GridItemCreated(e, "location/locationpanel.aspx", "MainForm", "worklist", grdworklist);
    }

    protected void grdrecentlist_ItemCreated(object sender, GridItemEventArgs e)
    {
      screen3.GridItemCreated(e, "location/locationpanel.aspx", "MainForm", "recentlist", grdrecentlist);
    }
}