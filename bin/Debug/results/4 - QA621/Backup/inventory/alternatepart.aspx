<%@ Page Language="C#" AutoEventWireup="true" CodeFile="alternatepart.aspx.cs" Inherits="inventory_alternatepart"
...
<script type="text/javascript">
  ...
  function RowClick(sender, arg) {
    ...
    window.open("../inventory/invframe.aspx?itemnum=" + itemnum + "&mode=edit", "");
  }

  function editpart(index, itemnum) {
    
    var alterpart = "";
    if (index != "") {
      var grid = $find("grditemlist");
      var MasterTable = grid.get_masterTableView();var row = MasterTable.get_dataItems()[index];
      alterpart = MasterTable.getCellByColumnUniqueName(row, "ItemNum").innerHTML;
    }
    var URL = "alternatepartmain.aspx?itemnum=" + itemnum + "&alternateitemnum=" + alterpart;
