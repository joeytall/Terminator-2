...
public partial class route_routepanel : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        hidGetFirstRecord.Value = UserSettings.GetFirstRecordSetting("Route");

        grdworklist = new RadGrid();
        grdresults = new RadGrid();
        grdrecentlist = new RadGrid();

        screen = new AzzierScreen("route/routepanel.aspx", "MainForm", MainControlsPanel.Controls, "edit");
        ...
        grdresults.MasterTableView.DataKeyNames = new string[] { "RouteName" };
        grdresults.MasterTableView.ClientDataKeyNames = new string[] { "RouteName" };
        ...
        grdresults.Attributes.Add("serviceURL", "../InternalServices/ServiceRoute.svc/QueryResultRoute");
        ...
        //grdresults.ClientSettings.DataBinding.Location = "../InternalServices/ServiceRoute.svc";
        ...
        grdworklist.MasterTableView.DataKeyNames = new string[] { "RouteName" };
        ...
        grdworklist.MasterTableView.ClientDataKeyNames = new string[] { "RouteName" };
        ...
        screen2 = new AzzierScreen("route/routepanel.aspx", "MainForm", MainControlsPanel2.Controls);
        ...
        grdworklist.ClientSettings.DataBinding.Location = "../InternalServices/ServiceRoute.svc";
        ...
        grdrecentlist.MasterTableView.DataKeyNames = new string[] { "RouteName" };
        grdrecentlist.MasterTableView.ClientDataKeyNames = new string[] { "RouteName" };
        ...
        screen3 = new AzzierScreen("route/routepanel.aspx", "MainForm", MainControlsPanel3.Controls);
...
//        grdrecentlist.ClientSettings.DataBinding.SelectMethod = "GetRecentList";
        ...
        grdrecentlist.ClientSettings.DataBinding.Location = "../InternalServices/ServiceRoute.svc";
    ...
    {
        screen2.GridItemCreated(e,"route/routepanel.aspx","MainForm","worklist",grdworklist);
    }

    protected void grdresults_ItemCreated(object sender, GridItemEventArgs e)
    {
        screen.GridItemCreated(e, "route/routepanel.aspx", "MainForm", "results", grdresults);
    }

    protected void grdrecentlist_ItemCreated(object sender, GridItemEventArgs e)
    {
        screen3.GridItemCreated(e, "route/routepanel.aspx", "MainForm", "recentlist", grdrecentlist);
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            AzzierHeader.InitToolBar(toolbar, "RoutePanel");
    ...
    {
        SystemMessage msg = new SystemMessage("route/routepanel.aspx");
