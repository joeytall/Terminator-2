<%@ Page Language="C#" AutoEventWireup="true" CodeFile="infpanel.aspx.cs" Inherits="interface_infpanel" %>
...
<body style="background-image: url(../IMAGES/back.png); background-repeat: repeat-x;
    ...
    <script type="text/javascript">
        function getRecord() {
            ...
            infname = getSpecificGridItem("grdresults", 0, "InterfaceName");
            ...
            parent.mainmodule.document.location.href = "infmain.aspx?mode=edit&interfacename=" + infname;
            $("#hidpushrecord").val("0");
        }

        function rowClicked(sender, eventArgs) {
            var interfacename = eventArgs.getDataKeyValue("InterfaceName");
            var proceed = true;
            try {
            ...
            if (proceed) {
                parent.mainmodule.document.location.href = "infmain.aspx?mode=edit&interfacename=" + interfacename;
                var index = 0;
    ...
    <div id="header-wrap">
        <div style="display: block; width: 100%; height: 30px; position: relative; padding: 0 0 0 10px;
            ...
            <table width="90%">
                <tr>
                    <td align="right">
                        <a href="javascript:setLogoffCookie('logoff','1','INTERFACE')">Log Off</a>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <tr>
                    <td width="40%">
                        <asp:Label ID="lblListType" runat="server" Text="" Style="position: absolute; top: 9px;
                            ...
                            color: #FFFFFF;" onclick="chgframesizewithvalue('INTERFACE')"/>
                    </td>
...
<script type="text/javascript">
    ...
    function updatecounts(sender) {
        ...
        /*
            ...
            */
            var interfacename = "";
            if (parent.mainmodule.document.getElementById("txtinterfacename") != null)
                interfacename = parent.mainmodule.document.getElementById("txtinterfacename").value;
            //alert(wonum);
            var index = -1;
            ...
            if (interfacename != "") {
                ...
                for (var i = 0; i < allRows.length; i++) {
                  //alert(allRows[i].getDataKeyValue("wonum"));
                    if (allRows[i].getDataKeyValue("InterfaceName") == interfacename) {
                        //alert("set green");
...
<script type="text/javascript">
    ...
    function RadGrid_RowSelected(sender, args) {
        var mailID = args.getDataKeyValue("InterfaceName");
        if (!selected[mailID]) {
...
<script type="text/javascript">
    ...
    function worklistadd(grid) {
      ...
      $(document).ready(function () {
        ...
        for (var i = 0; i < selectedRows.length; i++) {
          ...
          var cell = MasterTable.getCellByColumnUniqueName(row, "InterfaceName");
        ...
        $.ajax({
          type: "GET",
          url: "../InternalServices/ServiceGeneral.svc/AddtoWorkList",
          data: { "idlist": ids, "module": "Interface" },
          dataType: "json",
    ...
    function removeworklist() {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: "GET",
                url: "../InternalServices/ServiceGeneral.svc/DelWorkList",
                data: { "idlist": ids,"module":"Interface" },
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                beforeSend: function (xhr, settings) {
