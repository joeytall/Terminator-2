<%@ Page Language="C#" AutoEventWireup="true" CodeFile="labourhistory.aspx.cs" Inherits="labour_labourhistory" %>
...
<body style="background-image: url(../IMAGES/back.png); background-repeat: repeat-x;
    ...
    <asp:Panel ID="MainControlsPanel" runat="server" CssClass="MainControlsPanelClass">
        ...
        <asp:SqlDataSource ID="EqpHistorySqlDataSource" runat="server" ProviderName="System.Data.OleDb">
        </asp:SqlDataSource>
    </asp:Panel>
