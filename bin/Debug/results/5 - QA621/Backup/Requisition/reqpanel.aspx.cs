...
public partial class requisition_reqpanel : System.Web.UI.Page
{
  ...
  protected void Page_Init(object sender, EventArgs e)
  {
    ...
    hidGetFirstRecord.Value = UserSettings.GetFirstRecordSetting("itemrequest");
    ...
    screen = new AzzierScreen("requisition/reqpanel.aspx", "MainForm", MainControlsPanel.Controls, "edit");
    ...
    grdresults.MasterTableView.DataKeyNames = new string[] { "ReqNum" };
    ...
    grdresults.MasterTableView.ClientDataKeyNames = new string[] { "ReqNum" };
    ...
    grdresults.Attributes.Add("serviceURL", "../InternalServices/ServiceREQ.svc/QueryResultREQ");
    //grdresults.ClientSettings.DataBinding.SelectMethod = "SearchlistData?wherestring=" + wherestring;
    //grdresults.ClientSettings.DataBinding.Location = "../InternalServices/ServiceREQ.svc";
    ...
    grdworklist.MasterTableView.DataKeyNames = new string[] { "ReqNum" };
    ...
    grdworklist.MasterTableView.ClientDataKeyNames = new string[] { "ReqNum" };
    ...
    screen2 = new AzzierScreen("requisition/reqpanel.aspx", "MainForm", MainControlsPanel2.Controls);
    ...
    grdworklist.ClientSettings.DataBinding.Location = "../InternalServices/ServiceREQ.svc";
    ...
    grdrecentlist.MasterTableView.DataKeyNames = new string[] { "ReqNum" };
    ...
    screen3 = new AzzierScreen("requisition/reqpanel.aspx", "MainForm", MainControlsPanel3.Controls);
    ...
    grdrecentlist.MasterTableView.ClientDataKeyNames = new string[] { "ReqNum" };
    ...
    grdrecentlist.ClientSettings.DataBinding.Location = "../InternalServices/ServiceREQ.svc";
  ...
  {
    screen3.GridItemCreated(e, "requisition/reqpanel.aspx", "MainForm", "recentlist", grdrecentlist);
  }

  protected void grdworklist_ItemCreated(object sender, GridItemEventArgs e)
  {
    screen2.GridItemCreated(e, "requisition/reqpanel.aspx", "MainForm", "worklist", grdworklist);
  }

  protected void grdresults_ItemCreated(object sender, GridItemEventArgs e)
  {
    screen.GridItemCreated(e, "requisition/reqpanel.aspx", "MainForm", "results", grdresults);
  }
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    ...
    if (!IsPostBack)
    {
      ...
      AzzierHeader.InitToolBar(toolbar, "reqpanel");
    }
    else
    {
      setPanel = true;
