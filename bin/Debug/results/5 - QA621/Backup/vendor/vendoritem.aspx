<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vendoritem.aspx.cs" Inherits="vendor_vendoritem" %>
...
<body style="background-image: url(../IMAGES/back.png); background-repeat: repeat-x;
    ...
    <asp:Panel ID="MainControlsPanel" runat="server" CssClass="MainControlsPanelClass">
        ...
        <telerik:RadAjaxManager ID="ajaxmanager" runat="server">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="grditemvendor">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="grditemvendor" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
            </AjaxSettings>
            <ClientEvents OnRequestStart="RequestStart" OnResponseEnd="ResponseEnd" />
        </telerik:RadAjaxManager>
        <asp:SqlDataSource ID="ItemVendor_SqlDataSource" runat="server" ProviderName="System.Data.OleDb">
        </asp:SqlDataSource>
...
<script type="text/javascript">
    ...
    function EditVendorItems(counter, tfield) {
        var URL = 'vendoritemdetail.aspx?counter=' + counter+"&referer="+tfield;
...
//        alert("1");
        var masterTable = $find('grditemvendor').get_masterTableView();
            masterTable.rebind();
    }
