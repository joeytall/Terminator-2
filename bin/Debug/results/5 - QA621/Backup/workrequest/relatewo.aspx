<%@ Page Language="C#" AutoEventWireup="true" CodeFile="relatewo.aspx.cs" Inherits="workrequest_relatewo" %>
...
<body style="background-image: url(../IMAGES/back.png); background-repeat: repeat-x;
    ...
    <asp:Panel ID="MainControlsPanel" runat="server" CssClass="MainControlsPanelClass">
        ...
        <asp:SqlDataSource ID="WOListSqlDataSource" runat="server" ProviderName="System.Data.OleDb">
        </asp:SqlDataSource>
    </asp:Panel>
