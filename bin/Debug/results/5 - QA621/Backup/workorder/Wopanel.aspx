<!DOCTYPE HTML> 
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Wopanel.aspx.cs" Inherits="workorder_Wopanel" %>
...
<body style="background-image: url(../IMAGES/back.png); background-repeat: repeat-x;
    ...
    <script type="text/javascript">
        ...
        function getRecord() {
            ...
            wonum = getSpecificGridItem("grdresults", 0, "WoNum");
            ...
            parent.mainmodule.loadrecord("workorder","wonum",wonum,"workorder");
            $("#hidpushrecord").val("0");
        }
...
try 
                ...
                {
                    parent.mainmodule.document.location.href = "Womain.aspx?mode=edit&wonum=" + wonum;
                }
            }
        }
    ...
    <div id="header-wrap">
        <div style="display: block; width: 100%; height: 30px; position: relative; padding: 0 0 0 10px;
            ...
            <table width="90%">
                <tr>
                    <td align="right">
                        <a href="javascript:setLogoffCookie('logoff','1','WO')">Log Off</a>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <tr>
                    <td width="40%" valign="middle">
                        <asp:Label ID="lblListType" runat="server" Text="" Style="position: absolute; top: 9px;
                            ...
                            color: #FFFFFF;" onclick="chgframesizewithvalue('WO')"/>
                    </td>
...
<script type="text/javascript">
    ...
    function updatecounts(sender) {
        ...
        if ((mode == "queryresult" && sender.get_id() == "grdresults") || (mode == "worklist" && sender.get_id() == "grdworklist") || (mode == "recentlist" && sender.get_id() == "grdrecentlist")) {
            var wonum = "";
            if (parent.mainmodule.document.getElementById("txtwonum") != null)
                wonum = parent.mainmodule.document.getElementById("txtwonum").value;
            var index = -1;
            ...
            if (wonum != "") {
                ...
                for (var i = 0; i < allRows.length; i++) {
                    ...
                    if (allRows[i].getDataKeyValue("WoNum") == wonum) {
                        //alert("set green");
                        allRows[i].get_element().bgcolor = 'lime';
                        index = i + 1;

                    }
                    else {
                        allRows[i].get_element().bgcolor = '';
                    }
                }
            }
            else {
...
<script type="text/javascript">
  ...
  window.onload = function () {
    ...
    //    var mailID = args.getDataKeyValue("WoNum");
    //    if (!selected[mailID]) {
        ...
        if (grid != null) {
            ...
            if (selectedrows.length == 0) {
                ...
                for (var i = 0; i < selectedrows.length; i++) {
                    ...
                    var cell = masterview.getCellByColumnUniqueName(row, "WoNum");
                    if (wolist == "")
                ...
                var URL;
                if (oper == 1)  // batchcomp
                    URL = "batchcomplete.aspx?wonum=" + wolist;
                else
                    URL = "batchclose.aspx?wonum=" + wolist;
                oWnd = radopen(URL, null);
                //oWnd.add_beforeClose(refreshGrid);
                oWnd.set_modal(true);
            }
        }
    }
...
<script type="text/javascript">
    ...
    function addworklist(grid) {
        $(document).ready(function () {
            ...
            for (var i = 0; i < selectedRows.length; i++) {
                var row = selectedRows[i];
                var cell = MasterTable.getCellByColumnUniqueName(row, "WoNum");
            ...
            $.ajax({
                type: "GET",
                url: "../InternalServices/ServiceWO.svc/AddtoWorkList",
    ...
    function removeworklist(hidmode) {
        ...
        $(document).ready(function () {
            ...
            xmlparam = xmlparam + "<LinkModule>workorder</LinkModule>";
            ...
            $.ajax({
                type: "GET",
                url: "../InternalServices/ServiceWO.svc/DelWorkList",
