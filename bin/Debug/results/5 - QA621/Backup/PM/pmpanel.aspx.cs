...
public partial class pm_pmpanel : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        hidGetFirstRecord.Value = UserSettings.GetFirstRecordSetting("PM");

        grdworklist = new RadGrid();
        grdresults = new RadGrid();
        grdrecentlist = new RadGrid();

        screen = new AzzierScreen("pm/pmpanel.aspx", "MainForm", MainControlsPanel.Controls, "edit");
        ...
        grdresults.MasterTableView.DataKeyNames = new string[] { "PmNum" };
        grdresults.MasterTableView.ClientDataKeyNames = new string[] { "PmNum" };
        ...
        grdresults.Attributes.Add("serviceURL", "../InternalServices/ServicePM.svc/QueryResultPM");
        ...
        //grdresults.ClientSettings.DataBinding.Location = "../InternalServices/ServicePM.svc";
        ...
        grdworklist.MasterTableView.DataKeyNames = new string[] { "PmNum" };
        ...
        grdworklist.MasterTableView.ClientDataKeyNames = new string[] { "PmNum" };
        ...
        screen2 = new AzzierScreen("pm/pmpanel.aspx", "MainForm", MainControlsPanel2.Controls);
        ...
        grdworklist.ClientSettings.DataBinding.Location = "../InternalServices/ServicePM.svc";
        ...
        grdrecentlist.MasterTableView.DataKeyNames = new string[] { "PmNum" };
        grdrecentlist.MasterTableView.ClientDataKeyNames = new string[] { "PmNum" };
        ...
        screen3 = new AzzierScreen("pm/pmpanel.aspx", "MainForm", MainControlsPanel3.Controls);
        ...
        grdrecentlist.ClientSettings.DataBinding.SelectMethod = "RecentListDataAndCount";// "GetRecentList";
        grdrecentlist.ClientSettings.DataBinding.Location = "../InternalServices/ServicePM.svc";
    ...
    {
        screen3.GridItemCreated(e,"pm/pmpanel.aspx","MainForm","recentlist",grdrecentlist);
    }

    protected void grdworklist_ItemCreated(object sender, GridItemEventArgs e)
    {
        screen2.GridItemCreated(e, "pm/pmpanel.aspx", "MainForm", "worklist",grdworklist);
    }

    protected void grdresults_ItemCreated(object sender, GridItemEventArgs e)
    {
        screen.GridItemCreated(e, "pm/pmpanel.aspx", "MainForm", "results", grdresults);
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            AzzierHeader.InitToolBar(toolbar, "PMPanel");
  ...
  /*
    protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
    {
        ...
        {
            screen.SaveSelectedList(grdresults, "equipment", out selectedresults);
            grdresults.PageSize = 100 + grdresults.PageSize;

            grdresults.Rebind();
            screen.SetSelecctedList(grdresults, "equipment", selectedresults);
        }
        else if (e.Argument == "LoadMoreWorkList")
        {
            screen.SaveSelectedList(grdworklist, "equipment", out selectedworklist);
            grdworklist.PageSize = 100 + grdworklist.PageSize;
            grdworklist.Rebind();
            screen.SetSelecctedList(grdworklist, "equipment", selectedworklist);
        }
        else if (e.Argument == "LoadMoreRecentList")
        {
            screen.SaveSelectedList(grdrecentlist, "equipment", out selectedrecentlist);
            grdrecentlist.PageSize = 100 + grdrecentlist.PageSize;
            grdrecentlist.Rebind();
            screen.SetSelecctedList(grdrecentlist, "equipment", selectedrecentlist);
        }
    }
   * */
    ...
    {
        SystemMessage msg = new SystemMessage("pm/pmpanel.aspx");
