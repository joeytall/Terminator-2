<%@ Page Language="C#" AutoEventWireup="true" CodeFile="labourpanel.aspx.cs" Inherits="labour_labourpanel" %>
...
<body style="background-image: url(../IMAGES/back.png); background-repeat: repeat-x;
    ...
    <script type="text/javascript">
        function getRecord() {
            ...
            empid = getSpecificGridItem("grdresults", 0, "Empid");
            ...
            parent.mainmodule.document.location.href = "labourmain.aspx?mode=edit&empid=" + empid;
            $("#hidpushrecord").val("0");
        }

        function rowClicked(sender, eventArgs) {
            var empid = eventArgs.getDataKeyValue("Empid");
            var proceed = true;
            try {
    ...
    <div id="header-wrap">
        <div style="display: block; width: 100%; height: 30px; position: relative; padding: 0 0 0 10px;
            ...
            <table width="90%">
                <tr>
                    <td align="right">
                        <a href="javascript:setLogoffCookie('logoff','1','LAB')">Log Off</a>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <tr>
                    <td width="40%">
                        <asp:Label ID="lblListType" runat="server" Text="" Style="position: absolute; top: 9px;
                            ...
                            color: #FFFFFF;" onclick="chgframesizewithvalue('LAB')"/>
                    </td>
...
<script type="text/javascript">
    ...
    function updatecounts(sender) {
      ...
      if ((mode == "queryresult" && sender.get_id() == "grdresults") || (mode == "worklist" && sender.get_id() == "grdworklist") || (mode == "recentlist" && sender.get_id() == "grdrecentlist")) {
            var empid = "";
            if (parent.mainmodule.document.getElementById("txtempid") != null)
                empid = parent.mainmodule.document.getElementById("txtempid").value;
            var index = -1;
            ...
            if (empid != "") {
                ...
                for (var i = 0; i < allRows.length; i++) {
                    ...
                    if (allRows[i].getDataKeyValue("Empid") == empid) {
                        //alert("set green");
...
<script type="text/javascript">
  ...
  $(window).load(function () {
    ...
    function RadGrid_RowSelected(sender, args) {
        var mailID = args.getDataKeyValue("Empid");
        if (!selected[mailID]) {
    ...
    function specsearch() {
        var URL;
        URL = "../util/specsearch.aspx?module=labour";
...
<script type="text/javascript">
    ...
    function worklistadd(grid) {
        ...
        $(document).ready(function () {
            ...
            var paramxml = "<?xml version='1.0' encoding='UTF-8'?><root><labour>";
            ...
            paramxml = paramxml + "</labour></root>";
            if (!allowsubmit()) return;
            $.ajax({
                type: "GET",
                url: "../InternalServices/ServiceLabour.svc/AddtoWorkList",
    ...
    function removeworklist() {
        ...
        $(document).ready(function () {
            ...
            xmlparam = xmlparam + "<LinkModule>labour</LinkModule>";
            ...
            $.ajax({
                type: "GET",
                url: "../InternalServices/ServiceLabour.svc/DelWorkList",
