...
public partial class interface_infpanel : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        hidGetFirstRecord.Value = UserSettings.GetFirstRecordSetting("Interface");
        ...
        AzzierScreen screen = new AzzierScreen("interface/infpanel.aspx", "MainForm", MainControlsPanel.Controls, "edit");
        ...
        grdresults.MasterTableView.DataKeyNames = new string[] { "InterfaceName" };
        ...
        grdresults.MasterTableView.ClientDataKeyNames = new string[] { "InterfaceName" };
        ...
        grdresults.Attributes.Add("serviceURL", "../InternalServices/ServiceInterface.svc/QueryResultInterface");

        grdresults.Skin = "Outlook";
        //grdresults.ClientSettings.DataBinding.SelectMethod = "SearchDataAndCount?wherestring=" + wherestring;
        //grdresults.ClientSettings.DataBinding.Location = "../InternalServices/ServiceInterface.svc";
        ...
        grdworklist.MasterTableView.DataKeyNames = new string[] { "InterfaceName" };
        ...
        grdworklist.MasterTableView.ClientDataKeyNames = new string[] { "InterfaceName" };
        ...
        AzzierScreen screen2 = new AzzierScreen("interface/infpanel.aspx", "MainForm", MainControlsPanel2.Controls);
        grdworklist.ClientSettings.Selecting.AllowRowSelect = true;
        ...
        grdworklist.ClientSettings.DataBinding.Location = "../InternalServices/ServiceInterface.svc";
        ...
        grdrecentlist.MasterTableView.DataKeyNames = new string[] { "InterfaceName" };
        ...
        AzzierScreen screen3 = new AzzierScreen("interface/infpanel.aspx", "MainForm", MainControlsPanel3.Controls);
        grdrecentlist.ClientSettings.Selecting.AllowRowSelect = true;
        ...
        grdrecentlist.MasterTableView.ClientDataKeyNames = new string[] { "InterfaceName" };
        ...
        grdrecentlist.ClientSettings.DataBinding.Location = "../InternalServices/ServiceInterface.svc";
