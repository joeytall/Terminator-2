<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vendorsrvc.aspx.cs" Inherits="vendor_vendorService" %>
...
<body style="background-image: url(../IMAGES/back.png); background-repeat: repeat-x;
    ...
    <asp:Panel ID="MainControlsPanel" runat="server" CssClass="MainControlsPanelClass">
        ...
        <telerik:RadAjaxManager ID="ajaxmanager" runat="server">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="grdvendorservice">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="grdvendorservice" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
            </AjaxSettings>
            <ClientEvents OnRequestStart="RequestStart" OnResponseEnd="ResponseEnd" />
        </telerik:RadAjaxManager>
        <asp:SqlDataSource ID="VendorService_SqlDataSource" runat="server" ProviderName="System.Data.OleDb">
        </asp:SqlDataSource>
...
<script type="text/javascript">
    ...
    function EditVendorServices(counter, tfield) {
        var URL = 'vendorsrvcdetail.aspx?counter=' + counter+"&referer="+tfield;
    ...
    function refreshGrid() {
        var masterTable = $find('grdvendorservice').get_masterTableView();
            masterTable.rebind();
    }
