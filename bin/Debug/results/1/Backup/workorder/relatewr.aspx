<%@ Page Language="C#" AutoEventWireup="true" CodeFile="relatewr.aspx.cs" Inherits="workorder_relatewr" %>
...
<body style="background-image: url(../IMAGES/back.png); background-repeat: repeat-x;
    ...
    <asp:Panel ID="MainControlsPanel" runat="server" CssClass="MainControlsPanelClass">
        ...
        <asp:SqlDataSource ID="WRListSqlDataSource" runat="server" ProviderName="System.Data.OleDb">
        </asp:SqlDataSource>
    </asp:Panel>
