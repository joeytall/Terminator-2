<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pmwolist.aspx.cs" Inherits="pm_pmwolist" %>
...
<script type="text/javascript">
  ...
  function RowMouseOver(sender, eventArgs) {
    ...
    $get(eventArgs.get_id()).style.cursor = "pointer";
  }

  function RowMouseOut(sender, eventArgs) {
    //$get(eventArgs.get_id()).className = "RowMouseOut";
    $get(eventArgs.get_id()).className = "default";
  }
  */
